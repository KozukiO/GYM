  ...
  <body data-spy="scroll" data-target="#navbarResponsive"> 
   ...
   <!--navbar creation -->
      <nav class="navbar navbar-expand-md navbar-dark bg-dark fixed-top">
        <a class="navbar-brand" href="index.html"><h1>BMI GYM</h1></a>
 ...
 <!--- Start of Portfolio Section --->
  <section id="about">
    ...
    <!-- Start Services Section ---->
     ...
     <div class="row no-padding">
        ...
        <div class= "narrow text-center">
          <div class="col-12">
            <p class="lead">Want To learn more about BMI GYM </p>
    ...
    <div class="col-12 narrow text-center ">
      <h1> PORTFOLIO </h1>
      <p class="lead" > Working 24/7 to fill your time here with good memories, <br> clients can quickly view your availability and timing of sessions.</p>
